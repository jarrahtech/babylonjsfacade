...
object xRWebXRRenderTargetTextureProviderMod {
  
  /* note: abstract class */ @JSImport("babylonjs/XR/webXRRenderTargetTextureProvider", "WebXRLayerRenderTargetTextureProvider")
  @js.native
