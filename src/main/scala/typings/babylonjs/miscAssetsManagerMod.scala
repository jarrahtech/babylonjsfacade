...
import typings.babylonjs.materialsTexturesCubeTextureMod.CubeTexture
import typings.babylonjs.materialsTexturesEquiRectangularCubeTextureMod.EquiRectangularCubeTexture
import typings.babylonjs.materialsTexturesHdrCubeTextureMod.HDRCubeTexture
...
object miscAssetsManagerMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Misc/assetsManager", "AbstractAssetTask")
  @js.native
  open class AbstractAssetTask protected () extends StObject {
    /**
