...
open class Texture protected ()
  extends typings.babylonjs.indexMod.Texture {
  /**
...
object Texture {
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.BILINEAR_SAMPLINGMODE")
  @js.native
  val BILINEAR_SAMPLINGMODE: Double = js.native
  
  /** Texture is not repeating outside of 0..1 UVs */
  @JSImport("babylonjs/Legacy/legacy", "Texture.CLAMP_ADDRESSMODE")
  @js.native
  val CLAMP_ADDRESSMODE: Double = js.native
  
  /** Cubic coordinates mode */
  @JSImport("babylonjs/Legacy/legacy", "Texture.CUBIC_MODE")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.EXPLICIT_MODE")
  @js.native
  val EXPLICIT_MODE: Double = js.native
  
  /** Equirectangular Fixed Mirrored coordinates mode */
  @JSImport("babylonjs/Legacy/legacy", "Texture.FIXED_EQUIRECTANGULAR_MIRRORED_MODE")
  @js.native
  val FIXED_EQUIRECTANGULAR_MIRRORED_MODE: Double = js.native
  
  /** Equirectangular Fixed coordinates mode */
  @JSImport("babylonjs/Legacy/legacy", "Texture.FIXED_EQUIRECTANGULAR_MODE")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_LINEAR")
  @js.native
  val LINEAR_LINEAR: Double = js.native
  
  /** Trilinear is mag = linear and min = linear and mip = linear */
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_LINEAR_MIPLINEAR")
  @js.native
  val LINEAR_LINEAR_MIPLINEAR: Double = js.native
  
  /** Bilinear is mag = linear and min = linear and mip = nearest */
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_LINEAR_MIPNEAREST")
  @js.native
  val LINEAR_LINEAR_MIPNEAREST: Double = js.native
  
  /** mag = linear and min = nearest and mip = none */
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_NEAREST")
  @js.native
  val LINEAR_NEAREST: Double = js.native
  
  /** mag = linear and min = nearest and mip = linear */
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_NEAREST_MIPLINEAR")
  @js.native
  val LINEAR_NEAREST_MIPLINEAR: Double = js.native
  
  /** mag = linear and min = nearest and mip = nearest */
  @JSImport("babylonjs/Legacy/legacy", "Texture.LINEAR_NEAREST_MIPNEAREST")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_LINEAR")
  @js.native
  val NEAREST_LINEAR: Double = js.native
  
  /** mag = nearest and min = linear and mip = linear */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_LINEAR_MIPLINEAR")
  @js.native
  val NEAREST_LINEAR_MIPLINEAR: Double = js.native
  
  /** mag = nearest and min = linear and mip = nearest */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_LINEAR_MIPNEAREST")
  @js.native
  val NEAREST_LINEAR_MIPNEAREST: Double = js.native
  
  /** mag = nearest and min = nearest and mip = none */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_NEAREST")
  @js.native
  val NEAREST_NEAREST: Double = js.native
  
  /** nearest is mag = nearest and min = nearest and mip = linear */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_NEAREST_MIPLINEAR")
  @js.native
  val NEAREST_NEAREST_MIPLINEAR: Double = js.native
  
  /** mag = nearest and min = nearest and mip = nearest */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_NEAREST_MIPNEAREST")
  @js.native
  val NEAREST_NEAREST_MIPNEAREST: Double = js.native
  
  /** nearest is mag = nearest and min = nearest and no mip */
  @JSImport("babylonjs/Legacy/legacy", "Texture.NEAREST_SAMPLINGMODE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "Texture.OnTextureLoadErrorObservable")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.PLANAR_MODE")
  @js.native
  val PLANAR_MODE: Double = js.native
  
  /** Projection coordinates mode */
  @JSImport("babylonjs/Legacy/legacy", "Texture.PROJECTION_MODE")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Texture.SPHERICAL_MODE")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs/Legacy/legacy", "Texture._SerializeInternalTextureUniqueId")
  @js.native
