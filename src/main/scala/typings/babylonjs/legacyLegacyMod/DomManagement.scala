...
object DomManagement {
  ...
  @JSImport("babylonjs/Legacy/legacy", "DomManagement")
  @js.native
  ...
  /**
    ...
    * @returns a string
    */
  @JSImport("babylonjs/Legacy/legacy", "DomManagement.GetDOMTextContent")
  @js.native
  ...
  /**
    ...
    * @returns true if the document object exists
    */
  @JSImport("babylonjs/Legacy/legacy", "DomManagement.IsDocumentAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the navigator object exists
    */
  @JSImport("babylonjs/Legacy/legacy", "DomManagement.IsNavigatorAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the window object exists
    */
  @JSImport("babylonjs/Legacy/legacy", "DomManagement.IsWindowObjectExist")
  @js.native
