...
@JSImport("babylonjs/Legacy/legacy", "ThinEngine")
@js.native
open class ThinEngine protected ()
  extends typings.babylonjs.indexMod.ThinEngine {
  /**
...
object ThinEngine {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine.CollisionsEpsilon")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine.ExceptionList")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine._CreateCanvas")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine._HasMajorPerformanceCaveat")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine._IsSupported")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs/Legacy/legacy", "ThinEngine._TextureLoaders")
  @js.native
