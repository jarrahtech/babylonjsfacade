...
import org.scalajs.dom.PointerEventInit
...
trait Scene
  ...
  /** @internal */
  val _isScene: /* true */ Boolean = js.native
  ...
  /** @internal */
  def _processLateAnimationBindingsForMatrices(holder: OriginalValue): Any = js.native
  ...
  def _readFileAsync(file: File, onProgress: js.Function1[/* ev */ ProgressEvent, Any]): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
  def _readFileAsync(file: File, onProgress: js.Function1[/* ev */ ProgressEvent, Any], useArrayBuffer: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
  ...
  def _requestFileAsync(url: String, onProgress: js.Function1[/* ev */ ProgressEvent, Unit]): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
  def _requestFileAsync(url: String, onProgress: js.Function1[/* ev */ ProgressEvent, Unit], useOfflineSupport: Boolean): js.Promise[String | js.typedarray.ArrayBuffer] = js.native
