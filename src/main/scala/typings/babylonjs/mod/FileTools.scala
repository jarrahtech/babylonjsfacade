...
object FileTools {
  ...
  @JSImport("babylonjs", "FileTools.BaseUrl")
  @js.native
  ...
  @JSImport("babylonjs", "FileTools.CorsBehavior")
  @js.native
  ...
  @JSImport("babylonjs", "FileTools.DefaultRetryStrategy")
  @js.native
  ...
  @JSImport("babylonjs", "FileTools.PreprocessUrl")
  @js.native
  ...
  inline def RequestFile(
    ...
    offlineProvider: Unit,
    useArrayBuffer: Boolean,
    onError: js.Function1[/* error */ typings.babylonjs.miscFileToolsMod.RequestFileError, Unit]
  ...
  inline def RequestFile(
    ...
    useArrayBuffer: Boolean,
    onError: js.Function1[/* error */ typings.babylonjs.miscFileToolsMod.RequestFileError, Unit],
    onOpened: js.Function1[/* request */ typings.babylonjs.miscWebRequestMod.WebRequest, Unit]
