...
open class Texture protected ()
  extends typings.babylonjs.legacyLegacyMod.Texture {
  /**
...
object Texture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "Texture.OnTextureLoadErrorObservable")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs", "Texture._SerializeInternalTextureUniqueId")
  @js.native
