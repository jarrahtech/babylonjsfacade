...
object DomManagement {
  ...
  @JSImport("babylonjs/Misc/index", "DomManagement")
  @js.native
  ...
  /**
    ...
    * @returns a string
    */
  @JSImport("babylonjs/Misc/index", "DomManagement.GetDOMTextContent")
  @js.native
  ...
  /**
    ...
    * @returns true if the document object exists
    */
  @JSImport("babylonjs/Misc/index", "DomManagement.IsDocumentAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the navigator object exists
    */
  @JSImport("babylonjs/Misc/index", "DomManagement.IsNavigatorAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the window object exists
    */
  @JSImport("babylonjs/Misc/index", "DomManagement.IsWindowObjectExist")
  @js.native
