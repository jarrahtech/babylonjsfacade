...
object DomManagement {
  ...
  @JSImport("babylonjs/index", "DomManagement")
  @js.native
  ...
  /**
    ...
    * @returns a string
    */
  @JSImport("babylonjs/index", "DomManagement.GetDOMTextContent")
  @js.native
  ...
  /**
    ...
    * @returns true if the document object exists
    */
  @JSImport("babylonjs/index", "DomManagement.IsDocumentAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the navigator object exists
    */
  @JSImport("babylonjs/index", "DomManagement.IsNavigatorAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the window object exists
    */
  @JSImport("babylonjs/index", "DomManagement.IsWindowObjectExist")
  @js.native
