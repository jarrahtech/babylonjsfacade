...
open class AudioEngine ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var onAudioLockedObservable: typings.babylonjs.BABYLON.Observable[IAudioEngine] = js.native
  
  /**
    * Event raised when audio has been unlocked on the browser.
    */
  /* CompleteClass */
  var onAudioUnlockedObservable: typings.babylonjs.BABYLON.Observable[IAudioEngine] = js.native
