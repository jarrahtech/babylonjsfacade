...
object Tools {
  ...
  /**
    ...
    */
  inline def DumpFramebuffer(width: Double, height: Double, engine: typings.babylonjs.BABYLON.Engine): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("DumpFramebuffer")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], engine.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  @js.native
  val PerformanceConsoleLogLevel: /* 2 */ Double = js.native
  ...
  @js.native
  val PerformanceNoneLogLevel: /* 0 */ Double = js.native
  ...
  @js.native
  val PerformanceUserMarkLogLevel: /* 1 */ Double = js.native
  ...
  @JSGlobal("BABYLON.Tools._IsOffScreenCanvas")
  @js.native
