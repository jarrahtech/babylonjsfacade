...
trait XRRenderStateInit extends StObject {
  ...
  var layers: js.UndefOr[js.Array[EventTarget]] = js.undefined
}
object XRRenderStateInit {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: XRRenderStateInit] (val x: Self) extends AnyVal {
    ...
    inline def setLayers(value: js.Array[EventTarget]): Self = StObject.set(x, "layers", value.asInstanceOf[js.Any])
    
    inline def setLayersUndefined: Self = StObject.set(x, "layers", js.undefined)
    
    inline def setLayersVarargs(value: EventTarget*): Self = StObject.set(x, "layers", js.Array(value*))
  }
}
