...
trait XRFrame extends StObject {
  ...
  var createAnchor: js.UndefOr[js.Function2[/* pose */ XRRigidTransform, EventTarget, js.Promise[XRAnchor]]] = js.undefined
  ...
  // Hand tracking
  var getJointPose: js.UndefOr[js.Function2[/* joint */ XRJointSpace, EventTarget, XRJointPose]] = js.undefined
...
object XRFrame {
  ...
  implicit open class MutableBuilder[Self <: XRFrame] (val x: Self) extends AnyVal {
    ...
    inline def setCreateAnchor(value: (/* pose */ XRRigidTransform, EventTarget) => js.Promise[XRAnchor]): Self = StObject.set(x, "createAnchor", js.Any.fromFunction2(value))
    ...
    inline def setGetJointPose(value: (/* joint */ XRJointSpace, EventTarget) => XRJointPose): Self = StObject.set(x, "getJointPose", js.Any.fromFunction2(value))
