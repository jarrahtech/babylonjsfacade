...
trait XMLHttpRequest
  ...
  def open(method: java.lang.String, url: org.scalajs.dom.URL): Unit = js.native
  def open(method: java.lang.String, url: org.scalajs.dom.URL, async: scala.Boolean): Unit = js.native
  def open(
    method: java.lang.String,
    url: org.scalajs.dom.URL,
    async: scala.Boolean,
    username: java.lang.String
  ): Unit = js.native
  def open(
