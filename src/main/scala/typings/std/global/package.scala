...
inline def addEventListener_copy(
  `type`: copy,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]
): Unit = (js.Dynamic.global.applyDynamic("addEventListener")(`type`.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def addEventListener_copy(
  `type`: copy,
  listener: js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any],
...
inline def oncopy: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null = js.Dynamic.global.selectDynamic("oncopy").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null]
inline def oncopy_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("oncopy")(x.asInstanceOf[js.Any])
...
inline def oncut: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null = js.Dynamic.global.selectDynamic("oncut").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null]
inline def oncut_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("oncut")(x.asInstanceOf[js.Any])
...
inline def onpaste: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null = js.Dynamic.global.selectDynamic("onpaste").asInstanceOf[(js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null]
inline def onpaste_=(x: (js.ThisFunction1[/* this */ Window, /* ev */ org.scalajs.dom.ClipboardEvent, Any]) | Null): Unit = js.Dynamic.global.updateDynamic("onpaste")(x.asInstanceOf[js.Any])
